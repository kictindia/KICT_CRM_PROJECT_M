...
import bgimage from '../../assets/marksheet.png';
...
const ViewMarksheetPage = () => {
  ...
  // Helper function to actually capture and print the certificate
    ...
    <MainDashboard>
      ...
      <CertificateContainer id="containerDiv">
        ...
        <DataOverlay>
          ...
          <Text style={{ top: '25.8rem', left: '11rem', fontSize: '12px', fontWeight: '700' }}>
...
export default ViewMarksheetPage;
